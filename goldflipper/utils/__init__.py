...
class PlayLogger:
    ...
    def import_all_plays(self):
        ...
        try:
            subfolders = [
                name for name in os.listdir(self.base_directory) if os.path.isdir(os.path.join(self.base_directory, name)) and name.lower() != "old"
            ]
        except Exception as e:
    ...
    def log_play(self, play_data: dict[str, Any], status: str, source_filename: str | None = None):
        ...
        premium_open = safe_float(
            logging_data.get("premium_atOpen")
            if logging_data.get("premium_atOpen") is not None
            else (entry_point.get("entry_premium") if opened_by_entry_premium else None)
        )
        price_open = safe_float(
            logging_data.get("price_atOpen")
            if logging_data.get("price_atOpen") is not None
            else (entry_point.get("entry_stock_price") if opened_by_entry_premium else None)
        )
    ...
    def export_to_spreadsheet(self, format: str = "csv", save_to_desktop: bool | None = None) -> dict[str, str | None]:
        """
        ...
        if format == "both":
            ...
            csv_result = self._export_csv(export_dir, timestamp, desktop_path, save_to_desktop)
            result_paths.update(
                {"csv_file": csv_result["main_file"], "main_file": csv_result["main_file"], "desktop_file": csv_result["desktop_file"]}
            )
            ...
            excel_result = self._export_excel(export_dir, timestamp, desktop_path, save_to_desktop)
            result_paths.update(
                {"excel_file": excel_result["main_file"], "main_file": excel_result["main_file"], "desktop_file": excel_result["desktop_file"]}
            )
    ...
    def _export_csv(self, export_dir, timestamp, desktop_path, save_to_desktop):
        ...
        result: dict[str, str | None] = {"main_file": None, "desktop_file": None}
    ...
    def _export_excel(self, export_dir, timestamp, desktop_path, save_to_desktop):
        ...
        writer = pd.ExcelWriter(export_path, engine="xlsxwriter", engine_kwargs={"options": {"nan_inf_to_errors": True}})
        ...
        with writer as writer:
            ...
            money_format_even = workbook.add_format(
                {"num_format": "$#,##0.00", "align": "center", "bg_color": "#F2F2F2", "border_color": border_color, "border": 1}
            )

            money_format_odd = workbook.add_format(
                {"num_format": "$#,##0.00", "align": "center", "bg_color": "white", "border_color": border_color, "border": 1}
            )

            # Strike price format (no cents)
            strike_format_even = workbook.add_format(
                {"num_format": "$#,##0", "align": "center", "bg_color": "#F2F2F2", "border_color": border_color, "border": 1}
            )

            strike_format_odd = workbook.add_format(
                {"num_format": "$#,##0", "align": "center", "bg_color": "white", "border_color": border_color, "border": 1}
            )

            # Profit/Loss formats with colors
            profit_format_even = workbook.add_format(
                {"num_format": "+$#,##0.00;-$#,##0.00", "align": "center", "bg_color": profit_color, "border_color": border_color, "border": 1}
            )
            ...
            loss_format_even = workbook.add_format(
                {"num_format": "+$#,##0.00;-$#,##0.00", "align": "center", "bg_color": loss_color, "border_color": border_color, "border": 1}
            )
            ...
            profit_pct_format_even = workbook.add_format(
                {"num_format": "0.00%", "align": "center", "bg_color": profit_color, "border_color": border_color, "border": 1}
            )
            ...
            loss_pct_format_even = workbook.add_format(
                {"num_format": "0.00%", "align": "center", "bg_color": loss_color, "border_color": border_color, "border": 1}
            )
            ...
            even_row_format = workbook.add_format({"bg_color": "#F2F2F2", "align": "center", "border_color": border_color, "border": 1})

            odd_row_format = workbook.add_format({"bg_color": "white", "align": "center", "border_color": border_color, "border": 1})

            even_row_format_left = workbook.add_format({"bg_color": "#F2F2F2", "align": "left", "border_color": border_color, "border": 1})

            odd_row_format_left = workbook.add_format({"bg_color": "white", "align": "left", "border_color": border_color, "border": 1})

            date_format = workbook.add_format({"num_format": "yyyy-mm-dd", "align": "center", "border_color": border_color, "border": 1})

            time_format = workbook.add_format({"num_format": "hh:mm:ss", "align": "center", "border_color": border_color, "border": 1})

            # Add date and time formats with alternating shades
            date_format_even = workbook.add_format(
                {"num_format": "yyyy-mm-dd", "align": "center", "bg_color": "#F2F2F2", "border_color": border_color, "border": 1}
            )

            date_format_odd = workbook.add_format(
                {"num_format": "yyyy-mm-dd", "align": "center", "bg_color": "white", "border_color": border_color, "border": 1}
            )

            time_format_even = workbook.add_format(
                {"num_format": "hh:mm:ss", "align": "center", "bg_color": "#F2F2F2", "border_color": border_color, "border": 1}
            )

            time_format_odd = workbook.add_format(
                {"num_format": "hh:mm:ss", "align": "center", "bg_color": "white", "border_color": border_color, "border": 1}
            )
    ...
    def _create_summary_stats(self, strategy_filter: str | None = None) -> pd.DataFrame:
        ...
        try:
            ...
            stats_df = pd.DataFrame(
                {"total_trades": [total_trades], "winning_trades": [winning_trades], "win_rate": [win_rate], "total_pl": [total_pl]}
            )
