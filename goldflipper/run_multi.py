...
def main():
    ...
    parser = argparse.ArgumentParser(description="Goldflipper Multi-Strategy Trading System")
    parser.add_argument("--mode", choices=["console"], default="console", help="Run mode (console)")
