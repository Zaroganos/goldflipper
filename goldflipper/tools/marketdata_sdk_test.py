...
def get_api_token_from_settings() -> Optional[str]:
...
def test_sdk_connection():
    ...
    try:
        ...
        logger.info(f"✓ SDK connected successfully! SPY quote received.")
...
def fetch_options_volume(client, symbol: str) -> Optional[OptionsVolumeData]:
...
def fetch_historical_candles(client, symbol: str, lookback_days: int = 14) -> Optional[HistoricalStockData]:
...
def run_momentum_data_fetch(symbols: Optional[list] = None, lookback_days: int = 14) -> MomentumDataStore:
    """
