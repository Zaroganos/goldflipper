...
def main():
    ...
    parser.add_argument("--fix-only-file", "-f", type=str, help="Fix only a specific file (filename or path)")
    ...
    try:
        fixed_count = run_fixer(verbose=args.verbose, specific_file=args.fix_only_file)
