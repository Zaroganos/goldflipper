...
def create_test_environment():
    ...
    play_dirs = ["plays/new", "plays/open", "plays/pending-opening", "plays/pending-closing", "plays/closed", "plays/expired", "plays/temp"]
...
def create_template_play_file(path, trade_type="PUT", play_class="SIMPLE"):
    ...
    template_play = {
        ...
        "entry_point": {"stock_price": 503.85, "order_type": "limit at bid", "entry_stock_price": 504.01, "entry_premium": 8.77},
        "strike_price": "499.0",
        ...
        "conditional_plays": {"OCO_triggers": [f"QQQ-{trade_type.lower()}-14-20250302-2210.json"], "OTO_triggers": []},
        ...
        "stop_loss": {"premium_pct": 35.0, "SL_type": "LIMIT", "order_type": "limit at mid", "SL_option_prem": 5.7005},
        "take_profit": {"premium_pct": 65.0, "order_type": "limit at mid", "TP_option_prem": 14.4705},
        "logging": {
            "delta_atOpen": -0.3433,
            "theta_atOpen": -0.3418,
