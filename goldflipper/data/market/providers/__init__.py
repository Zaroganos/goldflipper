...
from goldflipper.data.indicators.base import IndicatorCalculator, MarketData
...
class TTMSqueezeCalculator(IndicatorCalculator):
    ...
    def calculate(self) -> dict[str, pd.Series]:
        ...
        return {"squeeze_on": squeeze_on, "momentum": current_momentum, "momentum_increasing": momentum_increasing}
