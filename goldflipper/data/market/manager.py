...
class MarketDataManager:
    ...
    def _initialize_providers(self) -> dict[str, MarketDataProvider]:
        ...
        providers = {}
        provider_classes = {"marketdataapp": MarketDataAppProvider, "yfinance": YFinanceProvider, "alpaca": AlpacaProvider}
    ...
    def _try_providers(self, operation: str, *args) -> Any | None:
    ...
    def get_option_quote(self, contract_symbol: str) -> dict[str, float] | None:
