...
class BaseStrategy(ABC):
    ...
    def get_entry_action_for_play(self, play: Dict[str, Any]) -> OrderAction:
        ...
        if action_str:
            try:
                ...
                self.logger.warning(
                    f"Invalid action '{action_str}' in play, using strategy default"
                )
    ...
    def get_playbook_for_play(self, play: Dict[str, Any]) -> Optional[Any]:
        """
        ...
        """
        try:
            from goldflipper.strategy.playbooks import load_playbook_for_play, load_playbook
    ...
    def get_default_playbook(self) -> Optional[Any]:
        """
